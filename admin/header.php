    ...
    <div class="header-navbar navbar-expand-sm navbar navbar-horizontal navbar-fixed navbar-dark navbar-without-dd-arrow navbar-shadow" role="navigation" data-menu="menu-wrapper">
        <div class="navbar-container main-menu-content" data-menu="menu-container">
            <ul class="nav navbar-nav" id="main-menu-navigation" data-menu="menu-navigation">
                ...
                <li class="nav-item"><a class="dropdown-toggle nav-link" href="sales"><i class="la la-rupee"></i><span>Ventas</span></a>
                </li>
                <li class="nav-item"><a class="dropdown-toggle nav-link" href="categories"><i class="la la-tags"></i><span>Categorias</span></a>
                </li>
                <li class="nav-item"><a class="dropdown-toggle nav-link" href="suppliers"><i class="la la-truck"></i><span>Proveedores</span></a>
                </li>
                <li class="nav-item"><a class="dropdown-toggle nav-link" href="customers"><i class="la la-users"></i><span>Clientes</span></a>
                </li>
                <li class="nav-item"><a class="dropdown-toggle nav-link" href="users"><i class="la la-user-plus"></i><span>Usuarios</span></a>
                </li>
